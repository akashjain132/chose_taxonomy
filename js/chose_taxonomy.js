(function (jQuery) {
Drupal.behaviors.chose_taxonomy = {
  attach: function (context, settings) {
    jQuery(document).ready(function() {
      var clicked_image   = Drupal.settings.chose_taxonomy.cliked_image;
      var unclicked_image = Drupal.settings.chose_taxonomy.uncliked_image;
